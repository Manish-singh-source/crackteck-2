...
class ServiceRequestProductReturn extends Model
{
    use SoftDeletes;
    ...
    /**
     * Get the service request that owns this return.
     */
    ...
    {
        return $this->belongsTo(ServiceRequestProductPickup::class, 'pickups_id');
    }
