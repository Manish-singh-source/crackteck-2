...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('service_request_product_pickups', function (Blueprint $table) {
            ...
            $table->enum('status', ['pending', 'assigned', 'approved', 'picked', 'received', 'cancelled', 'returned', 'completed'])->default('pending')->comment('0 - Pending, 1 - Assigned, 2 - Approved, 3 - Picked, 4 - Received, 5 - Cancelled, 6 - Returned, 7 - Completed');
