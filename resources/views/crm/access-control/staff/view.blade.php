                                    ...
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div class="overflow-hidden ms-md-4 ms-0">
                                            ...
                                            <p class="my-1 text-muted fs-16">
                                                {{ ucwords(str_replace('_', ' ', $staff->staff_role)) }}</p>
                                            <span class="fs-15">KYC Status: <span
                                                    class="badge bg-success-subtle text-success px-2 py-1 fs-13 fw-normal">{{ ucwords($staff->kyc_status) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 class="mb-0 fs-22 text-dark me-3">{{ $totalTasks ?? 0 }}</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 class="mb-0 fs-22 text-dark me-3">{{ $completedTasks ?? 0 }}</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 class="mb-0 fs-22 text-dark me-3">{{ $pendingTasks ?? 0 }}</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 class="mb-0 fs-22 text-dark me-3">{{ $inProgressTasks ?? 0 }}</h3>
                                    </div>
