            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pay-to-vendors.update', $vendorPurchaseBill->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-12">
                                    <div class="text-start">
                                        ...
                                        <a href="{{ route('pay-to-vendors.index') }}" class="btn btn-secondary ms-2">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
