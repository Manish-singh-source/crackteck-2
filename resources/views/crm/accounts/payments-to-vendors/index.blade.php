    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div>
                    <a href="{{ route('pay-to-vendors.create') }}" class="btn btn-primary">Add Vendor Bill</a>
                </div>
            </div>
                            ...
                            <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('po_status') === null || request('po_status') === 'all' ? 'active' : '' }} p-2"
                                        href="{{ route('pay-to-vendors.index') }}">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('po_status') === 'pending' ? 'active' : '' }} p-2"
                                        href="{{ route('pay-to-vendors.index', ['po_status' => 'pending']) }}">
                                        <span class="d-block d-sm-none">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('po_status') === 'approved' ? 'active' : '' }} p-2"
                                        href="{{ route('pay-to-vendors.index', ['po_status' => 'approved']) }}">
                                        <span class="d-block d-sm-none">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('po_status') === 'rejected' ? 'active' : '' }} p-2"
                                        href="{{ route('pay-to-vendors.index', ['po_status' => 'rejected']) }}">
                                        <span class="d-block d-sm-none">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('po_status') === 'cancelled' ? 'active' : '' }} p-2"
                                        href="{{ route('pay-to-vendors.index', ['po_status' => 'cancelled']) }}">
                                        <span class="d-block d-sm-none">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @forelse($vendorPurchaseBills as $bill)
                                                                <tr class="align-middle">
                                                                    ...
                                                                    <td>
                                                                        <a aria-label="anchor"
                                                                            href="{{ route('pay-to-vendors.view', $bill->id) }}"
                                                                        ...
                                                                        <a aria-label="anchor"
                                                                            href="{{ route('pay-to-vendors.edit', $bill->id) }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('pay-to-vendors.destroy', $bill->id) }}"
