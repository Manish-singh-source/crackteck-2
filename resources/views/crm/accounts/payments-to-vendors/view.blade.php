...
<div class="content">
    <div class="container-fluid">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            ...
            <div>
                <a href="{{ route('pay-to-vendors.index') }}" class="btn btn-secondary">Back to List</a>
                <a href="{{ route('pay-to-vendors.edit', $vendorPurchaseBill->id) }}" class="btn btn-primary ms-2">Edit</a>
            </div>
        </div>
