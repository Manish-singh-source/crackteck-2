                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                @include('components.form.select', [
                                                    ...
                                                    'value' => old('service_type', (string) $coveredItem->service_type),
                                                ])
                                                @error('service_type')
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="status" id="status"
                                                    ...
                                                    <option value="1"
                                                        {{ old('status', (string) $coveredItem->status) == '1' ? 'selected' : '' }}>
                                                        Active
                                                    </option>
                                                    <option value="0"
                                                        {{ old('status', (string) $coveredItem->status) == '0' ? 'selected' : '' }}>
                                                        Inactive
                                                    </option>
                                                </select>
                                                @error('status')
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                @php
                                                    ...
                                                    if (is_string($oldDiagnosis)) {
                                                        ...
                                                        $diagnosisInitial = json_encode($coveredItem->diagnosis_list ?? []);
                                                    }
                                                @endphp
