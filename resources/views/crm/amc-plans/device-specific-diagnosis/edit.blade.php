        ...
        <div class="container-fluid">
                ...
                <div class="row ">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Device Specific Diagnosis</li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Device Specific Diagnosis</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="py-2 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Device Specific Diagnosis</h4>
                </div>
            </div>

            <div class="row">
                <div class="col-12">
                    <form action="{{ route('device-specific-diagnosis.update', $diagnosis->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm">
                                                <h5 class="card-title mb-0">
                                                    Edit Device Specific Diagnosis
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="status" id="status"
                                                    ...
                                                    <option value="active"
                                                        {{ old('status', $diagnosis->status) == 'active' ? 'selected' : '' }}>
                                                        Active
                                                    </option>
                                                    <option value="inactive"
                                                        {{ old('status', $diagnosis->status) == 'inactive' ? 'selected' : '' }}>
                                                        Inactive
                                                    </option>
                                                </select>
                                                @error('status')
