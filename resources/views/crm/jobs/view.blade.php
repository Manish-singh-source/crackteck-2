            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom-dashed">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-danger btn-sm" id="bulk-delete-devices-btn"
                                    style="display: none;">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-borderless dt-responsive nowrap" id="devices-table">
                                <thead>
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    {{-- @forelse($job->devices as $device)
                                        <tr class="align-middle device-row" data-device-id="{{ $device->id }}">
                                                    ...
                                                    <div>
                                                        @if ($device->image)
                                                            <img src="{{ asset('storage/' . $device->image) }}"
                                                                alt="{{ $device->product_name }}" width="100px"
                                                                class="img-fluid d-block">
                                                        @else
                                                            <img src="https://placehold.co/100x100?text=No+Image"
                                                                alt="No Image" width="100px" class="img-fluid d-block">
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>{{ $device->purchase_date ? $device->purchase_date->format('Y-m-d') : 'N/A' }}
                                            </td>
                                            <td>
                                    ...
                                    @empty
                                    @endforelse --}}
                                    <tr class="align-middle device-row" data-device-id="1">
                                        <td>
                                            <input type="checkbox" class="form-check-input device-checkbox" value="1">
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img src="https://placehold.co/100x100?text=No+Image" alt="No Image"
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush ">
                                ...
                                <li
                                    ...
                                    <span>
                                        <span class="badge bg-warning-subtle text-warning fw-semibold request-status">Raised
                                            Issue</span>
                                    </span>
                                </li>
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            <span>
                                                ...
                                                <div id="popupOverlay">
                                                    ...
                                                    <img id="popupImage"
                                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRevxmRXifnbO19nrfkzha4QLipReqGMcM33g&s"
                                                        alt="Popup Image">
                                                </div>
                                            </span>
                                        </li>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <select required="" name="engineer_id" id="engineer-select"
                ...
                <form action="#">
                    ...
                    <div class="modal-body p-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <select required="" name="eng-location" id="eng-location"
                                        class="form-select w-100">
                            ...
                            <div class="card-header border-bottom-dashed">
                                ...
                                <div class="col-sm-10 d-flex gap-2">
                                    <div class="form-check">
                                        <input class="form-check-input eng-assign" type="radio" name="gridRadios"
                                            id="individualRadio" value="individual" checked>
                            ...
                            <div class="card-body">
                                ...
                                <div id="individualDropdown">
                                    <select required name="status" class="form-select w-100">
                                        <option value="" selected disabled>---- Select Individual Engineer ----
                                        </option>
