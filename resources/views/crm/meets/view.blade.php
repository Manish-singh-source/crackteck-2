                                ...
                                <div class="col-lg-6">
                                    <ul class="list-group list-group-flush ">
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            <span>
                                                {{ $meet->leadDetails->lead_number ?? 'N/A' }}
                                            </span>
                                        </li>
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            <span>
                                                {{ $meet->leadDetails->customer->first_name ?? 'N/A' }}
                                                {{ $meet->leadDetails->customer->last_name ?? 'N/A' }}
                                            </span>
                                        </li>
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            <span class="fw-semibold text-break">Start Date & Time :
                                            </span>
                                            <span>
                                                {{ \Carbon\Carbon::parse($meet->date)->format('d M Y') }}
                                                -
                                                {{ \Carbon\Carbon::parse($meet->start_time)->format('h:i A') }}
                                            </span>

                                        </li>

                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            <span class="fw-semibold text-break">End Time :
                                            </span>
                                            <span>
                                                {{ $meet->end_time ? \Carbon\Carbon::parse($meet->end_time)->format('h:i A') : 'N/A' }}
                                            </span>
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            <span class="fw-semibold text-break">Attendees :</span>
                                            <span>
                                                {{ is_array($meet->attendees) ? implode(', ', $meet->attendees) : $meet->attendees ?? 'N/A' }}
                                            </span>
                                        </li>
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            @php
                                                $badgeClass = match ($meet->status) {
                                                    ...
                                                    'rescheduled' => 'bg-info-subtle text-info',
