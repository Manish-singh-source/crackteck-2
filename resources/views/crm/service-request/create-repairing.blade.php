...
@section('content')
        ...
        <div class="container-fluid">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Create Repairing Service Request</h4>
                </div>
            </div>

            <div class="row">
                <div class="col-12">
                    <form action="{{ route('repairing-service-requests.store') }}" method="POST" enctype="multipart/form-data"
                        id="nonAmcForm">
                        @csrf
                            ...
                            <div class="card-body">
                                <div class="row g-3 pb-3">
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div>
                                            <input type="hidden" name="service_type" value="repairing">
                                        </div>
                                        <div>
                                ...
                                <div class="product-entry border rounded p-3 mb-3" data-index="0">
                                    <div class="row g-3 pb-3">
                                        ...
                                        <div class="col-xl-4 col-lg-6">
                                            <div>
                                                @include('components.form.select', [
                                                    'class' => 'repairing-service-select',
                                                    'label' => 'Repairing Service',
                                                    'name' => 'products[0][repairing_service_id]',
                                                    'options' => $repairingServiceOptions,
                                                ])
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-lg-6">
                                            <div>
                                                @include('components.form.input', [
                                                    'class' => 'repairing-service-price',
                                                    'label' => 'Repairing Service Price',
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div>
                            @include('components.form.select', [
                                'class' => 'repairing-service-select',
                                'label' => 'Repairing Service',
                                'name' => 'products[${productIndex}][repairing_service_id]',
                                'options' => $repairingServiceOptions,
                            ])
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            const repairingServicePrices = @json($repairingService->pluck('service_charge', 'id'));

            $(document).on('change', '.repairing-service-select', function() {
                const id = $(this).val();

                const priceInput = $(this)
                    .closest('.product-entry')
                    .find('.repairing-service-price');

                if (repairingServicePrices[id]) {
                    priceInput.val(repairingServicePrices[id]);
                } else {
                    priceInput.val('');
                }
            });
