        ...
        <div class="container-fluid">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Installation Service Request</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('service-request.update-installation-service-request', $request->id) }}" method="POST"
                                            ...
                                            <div class="col-xl-4 col-lg-6">
                                                <div>
                                                    @include('components.form.select', [
                                                        ...
                                                        'name' => "products[$idx][installation_service_id]",
                                                        'options' => $installationServiceOptions,
                                                        'value' => old(
                                                            "products.$idx.installation_service_id",
                ...
                <div class="col-xl-4 col-lg-6">
                    <div>
                        @include('components.form.select', [
                            'class' => 'installation-service-select',
                            'label' => 'Installation Service',
                            'name' => 'products[__IDX__][installation_service_id]',
                            'options' => $installationServiceOptions,
                        ])
                    </div>
                </div>
