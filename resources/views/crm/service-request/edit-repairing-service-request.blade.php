        ...
        <div class="container-fluid">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Repairing Service Request</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('service-request.update-repairing-service-request', $request->id) }}" method="POST"
                                            ...
                                            <div class="col-xl-4 col-lg-6">
                                                <div>
                                                    @include('components.form.select', [
                                                        ...
                                                        'label' => 'Quick Service',
                                                        'name' => "products[$idx][repairing_service_id]",
                                                        'options' => $repairingServiceOptions,
                                                        'value' => old(
                                                            "products.$idx.repairing_service_id",
                ...
                <div class="col-xl-4 col-lg-6">
                    <div>
                        @include('components.form.select', [
                            'class' => 'quick-service-select',
                            'label' => 'Quick Service',
                            'name' => 'products[__IDX__][repairing_service_id]',
                            'options' => $repairingServiceOptions,
                        ])
                    </div>
                </div>
