                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            ...
                                            <span>{{ $request->amcPlan->plan_name }}</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Plan Code:</span>
                                            <span>{{ $request->amcPlan->plan_code }}</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Duration:</span>
                                            <span>{{ $request->amcPlan->duration }} months</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Total Visits:</span>
                                            <span>{{ $request->amcPlan->total_visits }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Plan Cost:</span>
                                            <span>₹{{ number_format($request->amcPlan->plan_cost, 2) }}</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Tax:</span>
                                            <span>₹{{ number_format($request->amcPlan->tax, 2) }}</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Total Cost:</span>
                                            <span class="fw-bold text-primary">₹{{ number_format($request->amcPlan->total_cost, 2) }}</span>
                                        </li>
                                        <li class="list-group-item border-0 d-flex gap-3">
                                            <span class="fw-semibold">Support Type:</span>
                                            <span>{{ $request->amcPlan->support_type }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>

                            @if($request->amcPlan->description)
                            <div class="mt-3">
                                <h6 class="fw-semibold">Description:</h6>
                                <p class="text-muted">{{ $request->amcPlan->description }}</p>
                            </div>
                            @endif

                            @if($request->amcPlan->covered_items && count($request->amcPlan->covered_items) > 0)
                            <div class="mt-3">
                                <h6 class="fw-semibold">Covered Items:</h6>
                                <div class="row">
                                    @php
                                        $coveredItems = \App\Models\CoveredItem::whereIn('id', $request->amcPlan->covered_items)->get();
                                    @endphp
                                    @foreach($coveredItems as $item)
                                    <div class="col-md-6 mb-2">
                                        <span class="badge bg-success me-1">{{ $item->service_name }}</span>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            @if($request->amcPlan->tandc)
                            <div class="mt-3">
                                <h6 class="fw-semibold">Terms & Conditions:</h6>
                                <p class="text-muted small">{{ $request->amcPlan->tandc }}</p>
                            </div>
                            @endif

                            @if($request->amcPlan->replacement_policy)
                            <div class="mt-3">
                                <h6 class="fw-semibold">Replacement Policy:</h6>
                                <p class="text-muted small">{{ $request->amcPlan->replacement_policy }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
