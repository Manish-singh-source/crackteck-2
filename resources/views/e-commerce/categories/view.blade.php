                                                    ...
                                                    <tbody>
                                                        @foreach ($subCategories as $subCategory)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button"
                                                                        class="btn btn-warning btn-sm me-1 edit-subcategory"
...
@section('scripts')
    <script>
        $(document).ready(function() {
            // jQuery event handler for edit buttons (no function needed)
            $('.edit-subcategory').on('click', function(e) {
                ...
                // Fetch child category data via AJAX using jQuery
                $.ajax({
