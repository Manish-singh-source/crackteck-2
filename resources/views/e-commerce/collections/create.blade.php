                        ...
                        <div class="card-body">
                            <form action="{{ route('collection.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="image" class="form-label">Collection Image <span
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                                            rows="4" placeholder="Enter Collection Description">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">Collection Categories <span
                                                        class="text-danger">*</span></h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-8">
                                                        <label for="category_search" class="form-label">Search
                                                            Categories</label>
                                                        <input type="text" id="category_search" class="form-control"
                                                            placeholder="Type to search categories...">
                                                    </div>
                                                    <div class="col-lg-4 d-flex align-items-end">
                                                        <button type="button" id="add_category_btn" class="btn btn-success"
                                                            disabled>
