                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                        rows="3" placeholder="Enter coupon description">{{ old('description') }}</textarea>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>Buy X Get Y</option>
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" name="discount_value" class="form-control @error('discount_value') is-invalid @enderror"
                                        value="{{ old('discount_value') }}" step="0.01" min="0.01" placeholder="10.00" required>
                                    @error('discount_value')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">Max Discount</label>
                                    <input type="number" name="max_discount" class="form-control @error('max_discount') is-invalid @enderror"
                                        value="{{ old('max_discount') }}" step="0.01" min="0" placeholder="100.00">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" name="min_purchase_amount" class="form-control @error('min_purchase_amount') is-invalid @enderror"
                                        value="{{ old('min_purchase_amount') }}" step="0.01" min="0" placeholder="500.00">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="stackable" class="form-select @error('stackable') is-invalid @enderror">
                                    <option value="0" {{ old('stackable', 0) == 0 ? 'selected' : '' }}>No</option>
