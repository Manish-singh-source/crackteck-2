                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            value="{{ old('title', $coupon->title) }}" placeholder="Summer Sale 20% OFF"
                                            required>
                                        @error('title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        ...
                                        <select name="type" class="form-select @error('type') is-invalid @enderror"
                                            ...
                                            <option value="buy_x_get_y"
                                                {{ old('type', $coupon->type) == 'buy_x_get_y' ? 'selected' : '' }}>Buy X
                                                Get Y
                                            </option>
                                        </select>
                                        @error('type')
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" name="discount_value"
                                            ...
                                            min="0.01" placeholder="10.00" required>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="usage_per_customer"
                                        ...
                                        value="{{ old('usage_per_customer', $coupon->usage_per_customer) }}"
                                        min="1" placeholder="1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="stackable"
                                        ...
                                        <option value="0"
                                            {{ old('stackable', $coupon->stackable) == 0 ? 'selected' : '' }}>No</option>
                                        <option value="1"
                                            {{ old('stackable', $coupon->stackable) == 1 ? 'selected' : '' }}>Yes</option>
                                    </select>
                                    @error('stackable')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
