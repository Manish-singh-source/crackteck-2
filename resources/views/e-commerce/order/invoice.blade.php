                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tfoot>
                                        ...
                                        @if($totals['discount_amount'] > 0)
                                            <tr>
                                                <td colspan="6" class="text-end text-success"><strong>Discount:</strong></td>
                                                <td class="text-end text-success">-₹{{ number_format($totals['discount_amount'], 2) }}</td>
                                            </tr>
                                        @endif
                                        @if($totals['shipping_charges'] > 0)
                                            <tr>
                                                <td colspan="6" class="text-end"><strong>Shipping:</strong></td>
                                                <td class="text-end">₹{{ number_format($totals['shipping_charges'], 2) }}</td>
                                            </tr>
                                        @endif
