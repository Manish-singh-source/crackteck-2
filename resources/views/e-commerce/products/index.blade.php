                                        ...
                                        <div class="col-xl-10 col-md-10 col-sm-10">
                                            <div class="search-box">
                                                <input type="text" name="search" value=""
                                                    class="form-control search" placeholder="Search Product">
                                                            ...
                                                            @forelse($products as $product)
                                                                <tr class="align-middle">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span
                                                                            <span
                                                                            class="badge bg-{{ $product->status === '1' ? 'success' : 'danger' }}-subtle text-{{ $product->status === '1' ? 'success' : 'danger' }} fw-semibold">
