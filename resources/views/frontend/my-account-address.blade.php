            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="my-account-content account-address">
                        <h4 class="fw-semibold mb-20">Your addresses (<span
                                id="address-count">{{ $addresses->count() }}</span>)</h4>
                            ...
                            <form class="wd-form-address show-form-address mb-20" id="address-form" style="display: none;">
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="tf-cart-checkbox">
                                        <input type="checkbox" name="is_default" value="1" class="tf-check"
                                            id="is-default">
                                ...
                                <div class="box-btn">
                                    ...
                                    <button type="button" class="tf-btn btn-large btn-hide-address d-inline-flex"
                                        id="cancel-btn">
                                ...
                                @forelse($addresses as $address)
                                    <li class="account-address-item" data-address-id="{{ $address->id }}">
                                        ...
                                        <div class="info-detail">
                                            <div class="box-infor">
                                                <p class="title-sidebar">{{ $address->address1 }}</p>
                                                @if ($address->address2)
                                                    <p class="title-sidebar">{{ $address->address2 }}</p>
                                                @endif
                                                <p class="title-sidebar">{{ $address->city }}, {{ $address->state }}</p>
                                                <p class="title-sidebar">{{ $address->country }} -
                                                    {{ $address->pincode }}</p>
                                            </div>
                                            <div class="box-btn">
                                                <button class="tf-btn btn-large btn-edit-address"
                                                    data-address-id="{{ $address->id }}">
                                                    <span class="text-white">Edit</span>
                                                </button>
                                                <button class="tf-btn btn-large btn-delete-address"
                                                    data-address-id="{{ $address->id }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#address-form').on('submit', function(e) {
                ...
                console.log('Submitting form to URL:', method);
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $addressItem.fadeOut(300, function() {
                                ...
                                const currentCount = parseInt($('#address-count')
                                    .text());
