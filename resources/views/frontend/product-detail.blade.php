                                ...
                                <div class="swiper tf-product-media-main" id="gallery-swiper-started">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('frontend-assets/images/new-products/product-detail-1.png') }}"
                                        ...
                                        <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('frontend-assets/images/product/product-detail-2.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    ...
                                                    src="{{ asset('frontend-assets/images/product/product-detail-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('frontend-assets/images/product/product-detail-3.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    ...
                                                    src="{{ asset('frontend-assets/images/product/product-detail-3.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('frontend-assets/images/product/product-detail-4.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    ...
                                                    src="{{ asset('frontend-assets/images/product/product-detail-4.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{ asset('frontend-assets/images/product/product-detail-5.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    ...
                                                    src="{{ asset('frontend-assets/images/product/product-detail-5.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{ asset('frontend-assets/images/product/product-detail-6.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    ...
                                                    src="{{ asset('frontend-assets/images/product/product-detail-6.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('frontend-assets/images/new-products/product-detail-2.webp') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('frontend-assets/images/new-products/product-detail-4.webp') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('frontend-assets/images/new-products/product-detail-7.webp') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="beige">
                                                <div class="item">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('frontend-assets/images/new-products/product-detail-5.webp') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="beige">
                                                <div class="item">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('frontend-assets/images/new-products/product-detail-6.webp') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tf-product-info-content">
                                    <div class="infor-heading">
                                        ...
                                        <h5 class="product-info-name fw-semibold lh-base">
                                            Qubo Smart Cam 360 Q100 by HERO GROUP 3MP 1296p <br> WiFi CCTV 2 Way Talk Night
                                    ...
                                    <div class="">
                                        <div class="tf-product-info-choose-option flex-xl-nowrap">
                                            ...
                                            <div class="product-box-btn">
                                                ...
                                                <a href="{{ route('checkout', ['source' => 'buy_now']) }}"
                                                    class="tf-btn text-white btn-gray">
                                                    Buy now
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-main tab-des">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend-assets/images/new-products/product-detail-2.png') }}"
                                    data-src="{{ asset('frontend-assets/images/new-products/product-detail-2.png') }}"
                                    alt="" class="lazyload">
                            </div>
                            <p class="body-text-3">
